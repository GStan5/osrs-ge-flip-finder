(function () {
  ...
  const NAV_SECTIONS = [
    {
      ...
      label: "Economy",
      href: "/tools/flips",
      paths: ["/tools/flips", "/tools/recipes", "/tools/coffer", "/tools/alch", "/tools/enchant", "/tools/item", "/tools/flip-log"],
      tools: [
        ...
        { href: "/tools/enchant", label: "Enchant Jewellery", desc: "Jewellery profit ranks" },
  ...
  const TOOL_ICONS = {
    ...
    "/tools/enchant": "Dragonstone_ring.png",
    ...
    "/tools/slayer": "Slayer_helmet.png",
